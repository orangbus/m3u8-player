...
<html>
  <head>
    ...
    <title>OrangBus HTML5 Player P2P加速</title>
  ...
  <body>
    ...
    <div class="b-videobottom">
        <span class="b-adicon" style="display: inline;">Github: <a href="https://github.com/orangbus/m3u8-player" target="_blank">https://github.com/orangbus/m3u8-player</a></span>
	</div>
	<script>
